...
//! Used across the rustynum ecosystem wherever deterministic randomness is
//! needed: CLAM tree construction, test data generation, LSH projections,
//! ghost discovery templates.
//!
//! Consolidates 5 prior copies (3× splitmix64 in rustynum-clam, 2× xorshift
//! in rustynum-oracle) into a single canonical implementation.
